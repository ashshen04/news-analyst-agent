...
from nodes import analyze_news, fetch_news, find_conflicts, generate_report, summarize_for_memory
...
builder.add_node("summarize_for_memory", summarize_for_memory)
...
builder.add_edge("generate_report", "summarize_for_memory")
builder.add_edge("summarize_for_memory", END)
