...
class TestRunDaily:
    ...
    @patch("daily.graph")
    def test_full_run(self, mock_graph, mock_email, mock_s3, mock_collect, mock_evolve, tmp_db, monkeypatch):
    ...
    @patch("daily.send_email")
    @patch("daily.graph")
    def test_handles_topic_failure(self, mock_graph, mock_email, mock_s3, mock_collect, mock_evolve, tmp_db, monkeypatch):
    ...
    @patch("daily.send_email")
    @patch("daily.graph")
    def test_feedback_collected_before_report(self, mock_graph, mock_email, mock_s3, mock_collect, mock_evolve, tmp_db, monkeypatch):
